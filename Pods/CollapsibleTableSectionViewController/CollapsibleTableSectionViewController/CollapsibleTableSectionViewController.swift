...
open class CollapsibleTableSectionViewController: UIViewController {
    ...
    override open func viewDidLoad() {
        ...
        _tableView.register(UINib.init(nibName: "ReservationCustomCell", bundle: nil), forCellReuseIdentifier: "ReservationCustomCell")
...
extension CollapsibleTableSectionViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        return delegate?.collapsibleTableView?(tableView, cellForRowAt: indexPath) ?? UITableViewCell.init(style: UITableViewCellStyle.default, reuseIdentifier: "ReservationCustomCell")
    }
    ...
    public func tableView(_ tableView: UITableView, heightForHeaderInSection section: Int) -> CGFloat {
        return isSectionCollapsed(section) ? delegate?.collapsibleTableView?(tableView, heightForHeaderInSection: section) ?? 60.0 : 35
    }
